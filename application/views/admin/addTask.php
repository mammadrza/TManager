            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <form method="post" action="<?php echo base_url('addTaskAction') ?>"
                            ...
                            <div class="row">
                                ...
                                <!--                                                <option  value="Kişi">IT</option>-->
                                <!--                                                <option  value="Qadın">MArketing</option>-->
                                <!--                                            </select>-->
                                <!--                                        </div>-->
                                <!--                                    </div>-->
                                <!--                                </div>-->
                            ...
                            <!--                                    <div class="form-group">-->
                            <!--                                        <label class="bmd-label-floating">Departament</label>-->
                            <!--                                        <input name="departament" type="text" class="form-control">-->
                            <!--                                    </div>-->
                            <!--                                </div>-->
